...
//构造map_attr case里面要分别处理不同的属性 有几个属性就写几个case
...
//判断datas中的每个Information是不是left_or_remained的标签都是left或者remained
...
//返回datas中大多数left_or_remained是好是坏
